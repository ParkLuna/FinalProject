...
try:
    def main():
        obj=Restaurant("NARUTO UZUMAKI")
        print("*"*30, "WELCOME TO", obj.restro_name, "RESTAURANT", "*"*30,"\n")
        print("-"*89)
        print("\nHello Everyone I have made 'My First Project @ PYTHON in my Life :)\n")
        while True:
...
#The code is written as to get input from the users as i was reduced marks for codes that hadn't user input rule. 
